...
if __name__=="__main__":
    ...
    ke = klee_executor.klee_executor(pconfig, max_core, top_dir, heuristics_per_level, base_time, extract_options)
    ...
    wg = weight_generator.weight_generators[weight_func](data, top_dir, heuristics_per_level, kvalue)
